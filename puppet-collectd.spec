...
Version:	0.2
Release:	1cisco%{?dist}
Summary:	Puppet collectd module

Group:		System Environment/Base
License: 	Apache License 2.0	
URL:		https://github.com/CiscoSystems/puppet-collectd.git
...
%description
Installs collectd deamon and changes the default config file to the one under "files"
